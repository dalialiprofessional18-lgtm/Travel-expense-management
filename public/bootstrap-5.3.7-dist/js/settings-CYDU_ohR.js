import { m as c } from "./bootstrap.bundle.min.js";
document.addEventListener("alpine:init", () => {
  c.data("settingsComponent", () => ({
    sidebarVisible: !1,
    ...
    settings: {
      ...
      animations: !0,
      highContrast: !1,
      notifications: { desktop: !0, email: !0, sound: !1, marketing: !1 },
      privacy: { analytics: !0, performance: !0, activityHistory: !0 },
      storage: { autoCleanup: !0, cacheLimit: "1000" },
    },
    sections: [
      ...
      { id: "privacy", name: "Privacy", icon: "bi-shield-check" },
      { id: "storage", name: "Storage", icon: "bi-hdd" },
    ],
    init() {
      const e =
        ...
        "light";
      (this.settings.theme = e), this.loadSettings();
    },
    ...
    loadSettings() {
      ...
      if (e)
        try {
          ...
          console.warn("Failed to load saved settings:", t);
        }
    },
    saveSettings() {
      try {
    ...
    exportData(e) {
      ...
      switch (e) {
        ...
        case "pdf":
          ...
          return;
        case "xml":
          (i = this.convertToXML(t)),
            (s = "application/xml"),
            (o = "settings-export.xml");
          break;
        default:
          this.showNotification("Unsupported export format", "error");
          return;
      }
      const a = new Blob([i], { type: s }),
      ...
      (r.href = n),
        ...
        this.showNotification(`Data exported as ${e.toUpperCase()}`, "success");
    },
    convertToCSV(e) {
      const t = [];
      t.push("Setting,Value");
      const i = (s, o = "") => {
        for (const a in s)
          typeof s[a] == "object" && s[a] !== null
            ? i(s[a], o + a + ".")
            : t.push(`${o}${a},${s[a]}`);
      };
      return (

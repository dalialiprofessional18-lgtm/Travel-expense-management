                                    ...
                                    <div class="d-flex justify-content-between align-items-start gap-3">
                                      <div class="flex-grow-1">
                                        <div class="d-flex align-items-center gap-2 mb-2">
                                          <span class="badge bg-primary bg-opacity-10 text-white px-2 py-1">
        ...
        <div class="card border-0 shadow-lg rounded-4 mb-4">
          ...
          <div class="card-body p-4">
            ...
            <div class="p-4 rounded-4 text-center" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
              ...
              <div class="fw-bold text-white"><?= number_format($grandTotalVeloce + $grandTotalPerso, 2) ?>MAD</div>
            </div>
<!-- ✅ AFFICHAGE AMÉLIORÉ DES COMMENTAIRES -->
<!-- À placer après le "Total Général" dans la carte Résumé Financier -->
  ...
  <div class="mb-0">
    ...
    <?php if (!$commentaireManager && !$commentaireAdmin): ?>
      <div class="text-center py-4 text-muted">
        <i class="bi bi-chat-dots fs-3 d-block mb-2 opacity-25"></i>
...
<div class="card border-0 shadow-lg rounded-4 mb-4">
  ...
  <div class="card-body p-4">
    ...
    <div class="d-grid gap-2 mb-4">
      <!-- Télécharger -->
      <a href="/notes/<?= $note->getId() ?>/pdf/download" 
      ...
      <!-- Prévisualiser -->
      <a href="/notes/<?= $note->getId() ?>/pdf/preview" 
         target="_blank"
         class="btn btn-outline-danger">
    ...
    // Déterminer la classe et l'icône selon le statut
    $badgeClass = '';
    $badgeIcon = '';
    $badgeText = '';
    ...
    <?php elseif ($statut === 'valide_manager'): ?>
      ...
      <button class="btn btn-primary w-100 py-3 mb-3" disabled>
        ...
        En attente de validation d'admin
      </button>
    ...
    <?php elseif ($statut === 'rejetee_manager'): ?>
      ...
      <!-- Option pour repasser en brouillon -->
      <form action="/notes/updateStatut/<?= $note->getId() ?>" method="POST"
    ...
    <?php elseif ($statut === 'en_cours_admin'): ?>
      ...
      <button class="btn btn-info w-100 py-3 mb-3" disabled>
        ...
        En cours de traitement administratif
      </button>
    ...
    <?php elseif ($statut === 'approuve'): ?>
      <div class="alert alert-success border-0 shadow-sm mb-3" role="alert">
        <div class="d-flex align-items-center">
          <i class="bi bi-check-circle-fill fs-4 me-3"></i>
          <div>
            <h1 class="alert-heading mb-1 fw-bold">  Montant Rembourser                     <?= $commentaire?> MAD
</h1>
            <p class="mb-0 small">Votre demande a été approuvée définitivement par la Administration.</p>
          </div>
        </div>
